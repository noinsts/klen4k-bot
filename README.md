...
- **`.weather (city)`** – показує: температуру, вологість, опис погоди. Змінює рамку embed до погоди.  
- **`.setcity or addcity (city)`** – зберігає ваше місто в базі, щоб бот знав, звідки брати погоду.  
- **`.changecity (city)`** – змінює ваше місто в базі, якщо ви переїхали або зробили помилку.  
- **`.delcity`** – видаляє ваше місто з бази, якщо ви більше не хочете зберігати його.  
